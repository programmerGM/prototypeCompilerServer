function sintaticoExecuta(typeClient, tokens, res, req) {
    ...
    },
    {
        ...
        productions = [{
            ...
            code: 13,
            sentence: [118, 56, 106, 115, 7, 57, 36, 49, 50, 51, 4, 43, 105, 58, 42, 35, 50] // alterado - semântico
        }, {
            code: 14,
            sentence: [12]
        }, {
        ...
        {
            code: 118,
            nterm: 'ARMAZENA_TIPO_RETORNO_FUNCAO'
        }
        ]
            ...
            if (x == 15) { // se for null, NaN ou undefined, então é falso - antes estava if(top != null)
                ...
                if (isTerminal(x)) { // se for termina
                    if (x === a.code) { // é terminal
                        ...
                        error.message = 'Linha ' + (t.line + 1) + ': Erro no token \'' + t.token + '\''
                    }
                } else {
                    // se não for terminal									
                    switch (x) {
                        ...
                        case 105: // VERIFICA_RETORNO_FUNCAO
                            ...
                            for (let i = simbolTable.length - 1; i >= 0; i--){
                                if (simbolTable[i].category === 'function'){
                                    lastFunction = simbolTable[i]
                                    break
                                }
                            }
                        ...
                        case 115: // INSERE_NA_TABELA_DE_SIMBOLOS_FUNCAO
                            simbolTable[simbolTable.length - 1].name = a.name
                            break
                        ...
                        case 117: // ARMAZENA_NOME_VARIAVEL_TEMPORARIAMENTE
                            ...
                            break
                        case 118: // ARMAZENA_TIPO_RETORNO_FUNCAO
                            simbolTable.push(new Simbol('', 'function', findType(a.code), 'level'))
                            break
                    }
