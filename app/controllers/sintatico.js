function sintaticoExecuta(typeClient, tokens, res, req) {
    ...
    var tabelaParse = [{
        ...
        nterm = [{
            ...
            {
                code: 104,
                nterm: 'VERIFICA_name_VARIAVEL_REPETIDO'
            },
            {
                code: 105,
            ...
            {
                code: 106,
                nterm: 'VERIFICA_name_FUNCAO_REPETIDA'
            }, {
                code: 107,
            ...
            {
                code: 114,
                nterm: 'INSERE_NA_TABELA_DE_SimbolS_VARIAVEL'
            }, {
                code: 115,
                nterm: 'INSERE_NA_TABELA_DE_SimbolS_FUNCAO'
            }, {
                code: 116,
                nterm: 'ARMAZENA_name_E_type_VARIAVEL'
            }
        ];
    ...
    for (var a = 0; a < tokens.length; a++) {
        code.push({ name: tokens[a].token, code: tokens[a].code })
    }
    code.reverse()
    ...
    while (!!stack && stack[0] == 44) {
        ...
        a = code[code.length - 1]
        console.log("INICIADO WHILE")
        console.log('Códigos[sintáxico]: ' + code)
